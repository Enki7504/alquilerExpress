...
for id_prov, nombre in provincias:
    Provincia.objects.update_or_create(id=id_prov, defaults={'nombre': nombre})
localidades = [
            (1, 1, '25 de Mayo'),
            (2, 1, '3 de febrero'),
            (3, 1, 'A. Alsina'),
...
for id_loc, id_prov, nombre_localidad in localidades:
    provincia = Provincia.objects.get(id=id_prov)
    Ciudad.objects.update_or_create(
        id=id_loc,
        defaults={'nombre': nombre_localidad, 'provincia': provincia}
    )
